...
public class HomeFeedArrayAdapter extends ArrayAdapter<Content> implements AsyncResponse{
	...
	public HomeFeedArrayAdapter(Context context, int layoutid, List<Content> content, NewsFeedFragment f) {
